<template>
  <div class="layout-wrapper">
    <a style="display: inline-block;width: 80px;height: 80px;position: absolute;top: 0;right: 0;z-index: 1;" href="https://github.com/Liboq/qiankun-example" class="github-corner" aria-label="View source on GitHub">
